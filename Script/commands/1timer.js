...
module.exports.handleEvent = async ({ event, api, Users }) => {
  ...
  if (KEY.includes(event.body.toLowerCase()) !== false) {
    ...
    let session = (
    hours > 0001 && hours <= 400 ? "morning" : "সকাল হইছে সবাই ঘুম থেকে উঠো 😁",
    hours > 401 && hours <= 700 ? "morning" : "কয়বার ডাকবো তাড়াতাড়ি উঠো 🙄",
    hours > 701 && hours <= 1000 ? "shining" : "আমার নাছিম ঘুম থেকে উঠার সময় হয়ে গেছে👅😁",
    hours > 1001 && hours <= 1200 ? "lunch" : "দুপুরে লাঞ্চ করতে যাও সবাই🍌",
    hours > 1201 && hours <= 1700 ? "afternoon" : "আছর এর নামাজ এর টাইম হলো নামাজ পরে আসো🙂😍",
    hours > 1701 && hours <= 1800 ? "gloaming" : "খাওয়ার এর সময় হলো সবাই আসো 🌯🌮",
    hours > 1801 && hours <= 2100 ? "evening" : "সন্ধ্যা হইছে পড়তে বসো সবাই😽",
    ...
    let msg = {body: `Ami ai khane go`, mentions}
